...
to make Four-in-a-Row horizontally, vertically, or"""
	)
	...
	while True: # Run a player's turn.
		# Display the board an get player's move:
...
def displayBoard(Board):
	...
	# The list holds all of the board's tiles (and empty spaces) going left to right, top to bottom:
	tileChars = []
	for rowIndex in range(BOARD_HEIGHT):
		for columnIndex in range(BOARD_WIDTH):
...
def isWinner(playerTile, board):
	...
	return False  # In case none of the past conditions are fulfilled
